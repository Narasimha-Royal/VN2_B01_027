...
-> print ("factorial of 3 = ", fact(3))
Major difference between step and next command is that step command will cause a program to stop within a
function while next command executes a called function and stops after it.
